        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-4 text-gray-300">
              Providing expert physiotherapy care for adults. Our team of experienced therapists is dedicated to
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                ...
                <span>2781 ground floor (near by Amity global school), Sector 46, Gurugram</span>
              </li>
