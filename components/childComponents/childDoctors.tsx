...
export function ChildDoctorsSection() {
  const therapies = [
    {
      role: "Therapist",
  ...
  return (
    <section id="childdoctors" className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Doctors</h2>
        <p className="text-gray-600 max-w-2xl mx-auto">
          We offer a wide range of doctors and experts to address various conditions and help your child to
